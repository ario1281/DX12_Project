...
///スワップチェイン生成関数
HRESULT Direct3D12::CreateSwapChain(const HWND& hwnd) {
	RECT rc = {};
...
//コマンドまわり初期化
HRESULT Direct3D12::InitializeCommand() {
...
smart_ptr<ID3D12Device> Direct3D12::Device() {
	return _dev;
}
smart_ptr <ID3D12GraphicsCommandList> Direct3D12::CmdList() {
	return _cmdList;
}
smart_ptr <IDXGISwapChain4> Direct3D12::Swapchain() {
	return _swapchain;
}

bool Direct3D12::Init(HWND _hWnd)
{
#ifdef _DEBUG
	//デバッグレイヤーをオンに
	EnableDebugLayer();
